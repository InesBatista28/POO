...
public class TransactionTester {
    public static void main(String[] args) {
        ...
        tm.removeTransaction(1);
        tm.removeTransaction(2);

        tm.readFile("C:\\Users\\iness\\OneDrive\\Ambiente de Trabalho\\Engenharia Informática\\1ºAno\\2ºSemestre\\POO\\src\\miniteste2\\services.txt");
        tm.printAllTransactions();
